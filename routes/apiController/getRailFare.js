...
module.exports = function(req, res, next) {
    var url = "http://api.railwayapi.com/fare/train/"+ req.params.tno +"/source/"+ req.params.src +"/dest/"+ req.params.dst +"/age/18/quota/GN/doj/"+ req.params.doj +"/apikey/<your key>";
    console.log(url);
